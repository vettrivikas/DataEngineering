...
def main():
    ...
    pwords = load_wordlist("/home/data/Desktop/example/Streaming/Dataset/positive.txt")
    nwords = load_wordlist("/home/data/Desktop/example/Streaming/Dataset/negative.txt")
...
def stream(ssc, pwords, nwords, duration):
    ...
    ssc, topics = ['testtopic'], kafkaParams = {"metadata.broker.list": 'localhost:9092'})
